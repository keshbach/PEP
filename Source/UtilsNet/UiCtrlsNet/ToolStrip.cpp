...
void Common::Forms::ToolStrip::CreateGroup(
...
void Common::Forms::ToolStrip::DestroyGroup(
  System::String^ sGroupName)
{
    if (m_GroupToolStripItemsList != nullptr)
    {
...
void Common::Forms::ToolStrip::ShowGroup(
  System::String^ sGroupName)
{
    TGroupToolStripItems^ GroupToolItems = FindGroup(sGroupName);
...
Common::Forms::ToolStrip::TGroupToolStripItems^ Common::Forms::ToolStrip::FindGroup(
  System::String^ sGroupName)
{
